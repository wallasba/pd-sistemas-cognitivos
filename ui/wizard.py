...
def render_wizard():
    ...
    # ui/wizard.py – ETAPA 4 (substitua toda a seção de grafos)
...
# Usamos um placeholder para forçar a atualização sempre que os parâmetros mudarem
# A chave de cache é baseada em todos os parâmetros relevantes
